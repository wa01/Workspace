...
elif zoom == False: normFactor = "((LepGood_pt < 50)*0.5 + (LepGood_pt >= 50 && LepGood_pt < 100)*0.2 + (LepGood_pt >= 100)*0.1)"
...
effs[0].SetTitle("Electron Mismatch Efficiencies for Various IDs (" + inputSample + " Sample) ; Reconstructed Electron p_{T} / GeV ; Counts")
effs[0].SetName("eff1")
