...
h1.SetName("dR_0")
h1.SetTitle("DeltaR Distributions")
...
l1 = makeLegend()
l1.AddEntry("dR_0", "delta R (no ID)", "F")
...
h3.SetLineWidth(3)
l1.AddEntry("dR_loose", "Loose ID", "F")
...
h4.SetLineWidth(3)
l1.AddEntry("dR_medium", "Medium ID", "F")
...
h5.SetLineWidth(3)
l1.AddEntry("dR_tight", "Tight ID", "F")
...
h6.SetLineWidth(3)
l1.AddEntry("dR_wp90", "MVA ID (" + WP + ")", "F")
...
h7.SetLineWidth(3)
l1.AddEntry("dR_wp80", "MVA ID (" + WP + ")", "F")
...
#Write to file
savedir = "/afs/hephy.at/user/m/mzarucki/www/plots/electronReconstruction/electronID/combined/deltaR/" #web address: http://www.hephy.at/user/mzarucki/plots/electronReconstruction/electronIdEfficiency

if not os.path.exists(savedir):
   os.makedirs(savedir)

#Save to Web
c1.SaveAs(savedir + "electronID_deltaR_" + sample + ".root")
c1.SaveAs(savedir + "electronID_deltaR_" + sample + ".png")
c1.SaveAs(savedir + "electronID_deltaR_" + sample + ".pdf")
