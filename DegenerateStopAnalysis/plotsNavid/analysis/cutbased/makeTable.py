import pickle
import jinja2
from Workspace.DegenerateStopAnalysis.navidTools.Yields import Yields
import numpy as np
import glob
...
class JinjaTexTable():
  def __init__(self,yieldInstance, FOM=True, texDir="./tex/", pdfDir=pdfDir, outputName="",\
    ...
    self.out = texTemplate.render( yields=self.yields, yieldTable=self.yields.FOMTable.T)
    print(self.out)
