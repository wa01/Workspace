...
if not hasattr(samples.s,"cuts"):
  getPlots2(samples,plots,sr1Loose,sampleList=sampleList,plotList=["dmt"])
...
ind = False ## select False, 1,2,3 (corresoponding to different regs)

if not ind is False and a >= 0 :
    regs=[
